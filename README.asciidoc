...
link:https://github.com/ModelioOpenSource/Modelio/blob/master/LICENSE[image:https://img.shields.io/github/license/ModelioOpenSource/Modelio[License]] link:https://github.com/ModelioOpenSource/Modelio/releases/latest[image:https://img.shields.io/github/v/release/ModelioOpenSource/Modelio[Latest Release]] link:https://www.modelio.org[image:https://img.shields.io/badge/website-modelio.org-2F6FED[Website]]
...
| Archimate
| link:https://github.com/ModelioOpenSource/Modelio/blob/master/Sample%20Projects/%5BArchiMate%20Example%5D%20Discount%20Travel%20for%20ArchiMate.zip[*Discount Travel for ArchiMate*]
...
| JavaDesigner
| link:https://github.com/ModelioOpenSource/Modelio/blob/master/Sample%20Projects/%5BJAVA%20Example%5D%20Java%20Browser.zip[*Java Browser*]
| A simple HTML browser, based on a swing JEditorPane component.

| SysML
| link:https://github.com/ModelioOpenSource/Modelio/blob/master/Sample%20Projects/%5BSysML%20Example%5D%20The%20plant.zip[*The plant*]
...
| UML
| link:https://github.com/ModelioOpenSource/Modelio/blob/master/Sample%20Projects/%5BUML%20Example%5D%20Shopping%20Cart.zip[*Shopping Cart*]
| This project contains the model for the Online Shopping Cart system, including all the models used to specify and realize the IT system. This model addresses the development of an online shopping cart system, that allows suppliers to sell their products directly online to customers. It is provided as a UML example covering the analysis of the business context and processes, and the design and deployment of a possible implementation.
|===
...
[NOTE]
====
If you don't see the Modelio layout above, but wish to continue with this Quick Start, expand your project in the Model pane until you see a folder icon with the same name as your project, and select "Create diagram..." from the context menu, typically by right-clicking on that icon.
====
